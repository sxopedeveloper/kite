    ...
    <div class="container-fluid">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Add New Group</h5>
                <form action="<?php echo base_url();?>Script/save_group" method="POST">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <table class="table table-respnsive table-striped datatable" id="example">
                          <tbody>
                              <?php
                                ...
                                $bro = json_decode($details[0]->s_bro,true);
                                foreach ($data as $s) {
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-4'>";
                                                           if(isset($limit[$mykey])){
                                                            ...
                                                            echo "<input class='form-control form-control-sm ".$mykey." ' type='text' placeholder='Limit' name='data[limit][".$mykey."]' value='' disabled>";
                                                        ...
                                                        <div class='col-md-4'>";
                                                         if(isset($single[$mykey])){
                                                            echo "<input class='form-control form-control-sm ".$mykey." ' type='text' placeholder='Single Shot Limit' name='data[single][".$mykey."]' value='".($single[$mykey])."'>";
                                                         }else{
                                                            echo "<input class='form-control form-control-sm ".$mykey." ' type='text' placeholder='Single Shot Limit' name='data[single][".$mykey."]' value=''  disabled>";

                                                         }
                                                        echo "</div>
                                                        <div class='col-md-4'>";
                                                           if(isset($bro[$mykey])){
                                                            echo "<input class='form-control form-control-sm ".$mykey." ' type='text' placeholder='Brokrage' name='data[bro][".$mykey."]' value='".($bro[$mykey])."' >";
                                                           }else{
                                                            echo "<input class='form-control form-control-sm ".$mykey." ' type='text' placeholder='Brokrage' name='data[bro][".$mykey."]' value='' disabled>";
