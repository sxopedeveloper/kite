    ...
    <nav class="sidebar">
        <ul class="nav flex-column h-100">
            <li class="nav-item my-2">
                <a href="<?php echo base_url(); ?>index.php/Client/" class="nav-link">
            ...
            <li class="nav-item my-2">
                <a href="<?php echo base_url(); ?>index.php/Client/report" class="nav-link p-3">
                    <i data-feather="file-text"></i>
                    <!--<img src="<?php echo base_url(); ?>assets/images/broker.svg" class="img-fluid" alt="">-->
                </a>
            </li> 
            <li class="nav-item mt-auto my-2 ">
                <a href="<?php echo base_url(); ?>index.php/Client/" class="nav-link p-3">
                    <!--<img src="<?php echo base_url(); ?>assets/images/script.svg" class="img-fluid" alt="">-->
                      <i data-feather="bar-chart-2"></i>
                </a>
            </li>
            <li class="nav-item mt-auto my-2">
                <a href="<?php echo base_url(); ?>index.php/Client/sett" class="nav-link p-3">
                    <!--<img src="<?php echo base_url(); ?>assets/images/setting.svg" class="img-fluid" alt="">-->
